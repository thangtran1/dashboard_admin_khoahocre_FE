...
const NearFooter = () => {
  return (
    <section className="bg-gray-300 pt-12 px-6 md:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center items-center bg-transparent w-full">
          <Image
            ...
            className="w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-3xl bg-transparent object-contain"
          />
        </div>
        ...
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <Button className="bg-blue-600 mb-4 hover:bg-blue-700 text-white font-semibold px-5 py-3 rounded flex items-center gap-2">
