...
import { GroupBuyData } from "./dataExport";
    ...
    <div className="relative w-full py-8">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">
          <span className="text-success">Độc Quyền Group Buy</span> Tại Khóa Học
          Rẻ
        </h2>
        <Link
          to={`/group-buy`}
              ...
              <SwiperSlide key={idx}>
                <div className="bg-muted rounded-lg border shadow p-2 relative overflow-hidden">
                  ...
                  <h3 className="text-base h-14 line-clamp-2 font-semibold mt-2">
                    <Link to={`/group-buy`}> {course.title}</Link>
                  </h3>
