  ...
  return (
    <>
      <footer className="bg-muted text-foreground">
        <div
          className={clsx(
            "w-full flex-col px-4 lg:px-16 md:w-[70%] gap-6 py-3  mx-auto grid grid-cols-2 md:grid-cols-5",
            contentWrapper
          )}
        >
          <div>
      ...
      <div className="bg-border/40">
        <div
          className={clsx(
            "w-full lg:px-16 mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4",
            contentWrapper
          )}
        >
        ...
        <button
          ...
          className="fixed bottom-14 right-8 z-50 w-12 h-12 rounded-full border border-primary text-primary hover:bg-primary hover:text-white transition flex items-center justify-center"
        >
          <ChevronUp size={16} />
        </button>
      </div>
