...
import maintenanceApi, { CreateMaintenanceDto, MaintenanceType } from "@/api/services/maintenanceApi";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            >
              <Option value={MaintenanceType.DATABASE}>
                <Space>
                  <Icon icon="lucide:database" className="w-4 h-4 text-purple-500" />
                  {t("sys.maintenance.type-database")}
                </Space>
              </Option>
              <Option value={MaintenanceType.SYSTEM}>
                <Space>
                  <Icon icon="lucide:settings" className="w-4 h-4 text-cyan-500" />
              ...
              <Option value={MaintenanceType.OTHER}>
                <Space>
                  <Icon icon="lucide:more-horizontal" className="w-4 h-4 text-gray-500" />
          ...
          >
            <RangePicker
              ...
              placeholder={[t("sys.maintenance.start-time"), t("sys.maintenance.end-time")]}
