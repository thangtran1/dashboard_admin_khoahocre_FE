...
export default function MaintenanceModal({
  ...
  return (
    <Modal
        ...
        <div className="flex items-center justify-between">
          ...
          {onUpdate && (
            ...
            >
              {t(
                isEditing
                  ? "sys.maintenance.cancel-edit"
                  : "sys.maintenance.edit"
              )}
            </Button>
          )}
        </div>
      ...
      onOk={isEditing ? handleSubmit : onClose}
      okText={
        isEditing ? t("sys.maintenance.update") : t("sys.maintenance.close")
      }
      cancelText={t("sys.maintenance.cancel")}
      width={isEditing ? 600 : 800}
    >
      {renderContent()}
    </Modal>
  );
